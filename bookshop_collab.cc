...
/* incompatibility abounds...
// facilitates case-insensitive search
struct ci_char_traits : public __gnu_cxx::char_traits<char>
...
class Books {
  public:
    Books() { 
      author_    = new std::string[3];  // = {"Deitel & Deitel", };  Not the place for assignments?
      title_     = new std::string[3];  //= {"C++...Program", };
      unitprice_ = new double[3];     // = {2500.00};
      publisher_ = new std::string[3];   //= {"Pearson"};
      quantity_  = new int[3];   //= {15,15,15};

//      author_ = {"Deitel & Deitel"};
//      title_  = {"C++...Program"};
//      unitprice_ = {2500.00};
//      publisher_ = {"Pearson"};
//      quantity_  = {"15"};
